...
class MyHomePage extends StatefulWidget {
  ...
  const MyHomePage({super.key, required this.fingerprintId});
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    super.initState();
    fingerprintId = widget.fingerprintId!;
    loadConnectionState();
  ...
  Future<void> navigateToManageFingerprints() async {
    if (isConnected) {
      final result = await Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) =>
              Managefingerprints(fingerprintId: fingerprintId),
        ),
      );
